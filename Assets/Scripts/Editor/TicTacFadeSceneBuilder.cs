...
{
    /// <summary>
    /// Arma la escena jugable de Tic-Tac-Fade con placeholders (sin sprites/arte final).
    /// Uso: menú "Tic-Tac-Fade > Build Placeholder Scene (1v1)".
    /// </summary>
    public static class TicTacFadeSceneBuilder
    {
        ...
        public static void BuildScene()
        {
            ...
            SetPrivateField(gameHud, "winBanner", winBanner.gameObject);
            SetPrivateField(gameHud, "winLabel", winLabel);

            var gameManagerGO = new GameObject("GameManager");
            var gameManager = gameManagerGO.AddComponent<GameManager>();
            SetPrivateField(gameManager, "boardView", boardView);
            SetPrivateField(gameManager, "hud", gameHud);
            ...
            Debug.Log($"Tic-Tac-Fade: escena placeholder creada en {ScenePath}. Le podés dar Play.");
        }
        ...
        static void SetPrivateField(object target, string fieldName, object value)
        {
            ...
            if (field == null)
                throw new System.Exception($"No se encontró el campo '{fieldName}' en {target.GetType().Name}");
